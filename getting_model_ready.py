...
def imgageFormation(lines):
    ...
    for line in lines:
        ...
        center_path = "data/data/IMG/" + centerFileName
        left_path   = "data/data/IMG/" + leftFileName
        right_path  = "data/data/IMG/" + rightFileName
...
history_object = model.fit_generator(train_generator, samples_per_epoch=len(train_samples), validation_data=validation_generator,nb_val_samples=len(validation_samples), nb_epoch=3, verbose=2)
model.save('model.h5')
